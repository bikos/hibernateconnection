...
10. Click NEXT and FINISH, this will create the classes for the tables in the database. All the classes will be under your source packages. This step will create corresponding mapping hbm.xml under src/main/resources. CHeck the number of mapping arguments through hibernate.cnfg.xml under mapping, remove the unnecessary mappings. 
  
11. As a final step, follow step 4, but select HibernateUtil.Java and click next. This will create the java class with the initialization of the hibernate session. 
